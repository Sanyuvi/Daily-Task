let data = [
  ...
  button1.classList.add('col','btn','btn-primary' )
  button1.setAttribute('onclick','pagination(1)')
  button1.textContent= 'First'
  column.appendChild(button1)

  let button2 = document.createElement('button')
  button2.classList.add('col','btn','btn-primary')
  button2.setAttribute('onclick','previouspage()')
  button2.textContent= 'Previous'
  column.appendChild(button2)

 let button3 = document.createElement('button')
  button3.classList.add('col','btn','btn-light')
  button3.setAttribute('onclick','pagination(1)')
  button3.textContent= '1'
  column.appendChild(button3)

  let button4 = document.createElement('button')
  button4.classList.add('col','btn','btn-light')
  button4.setAttribute('onclick','pagination(2)')
  button4.textContent= '2'
  column.appendChild(button4)

  let button5 = document.createElement('button')
  button5.classList.add('col','btn','btn-light')
  button5.setAttribute('onclick','pagination(3)')
  button5.textContent= '3'
  column.appendChild(button5)

  let button6 = document.createElement('button')
  button6.classList.add('col','btn','btn-light')
  button6.setAttribute('onclick','pagination(4)')
  button6.textContent= '4'
  column.appendChild(button6)

  let button13 = document.createElement('button')
  button13.classList.add('col','btn','btn-primary')
  button13.setAttribute('onclick','nextpage()')
  button13.textContent= 'Next'
  column.appendChild(button13)

  let button14 = document.createElement('button')
  button14.classList.add('col','btn','btn-primary')
  button14.setAttribute('onclick','pagination(4)')
  button14.textContent= 'Last'
  column.appendChild(button14)

  let row2 = document.createElement('div')
  row2.classList.add('row','m-3')
  ...
  row2.innerHTML = ''
    if((value==1)){
        for(i=0;i<25;i++){
            ...
            paragraph.innerHTML = `<ul type="disc"><li><b>Id :</b> ${data[i].id} </br> <b>Name :</b> ${data[i].name} </br> <b>Email :</b> ${data[i].email} </li></ul>`
